    ...
    <div className="home">
      <div className="container">
        <div className="serviceCard">
          ...
          <Link to={"/services/page"} className="card">
            <img src="../assets/imgs/service2.jpg" alt="" />
            <div>
              <h2>Резервуары горизонтальные стальные (РГС, РГСН, РГСП)</h2>
            </div>
          </Link>
          <Link to={"/services/page"} className="card">
            <img src="../assets/imgs/service3.jpg" alt="" />
            <div>
              <h2>Модульные АЗС</h2>
            </div>
          </Link>
          <Link to={"/services/page"} className="card">
            <img src="../assets/imgs/service4.jpg" alt="" />
            <div>
              <h2>Автоматическая блочная (мини) АЗС</h2>
            </div>
          </Link>
          <Link to={"/services/page"} className="card">
            <img src="../assets/imgs/service5.jpg" alt="" />
            <div>
              <h2>Контейнерные АЗС (КАЗС)</h2>
            </div>
          </Link>
          <Link to={"/services/page"} className="card">
            <img src="../assets/imgs/service6.jpg" alt="" />
            <div>
              <h2>Силосъг (для цемента, зерна, муки и т.д.)</h2>
            </div>
          </Link>
          <Link to={"/services/page"} className="card">
            <img src="../assets/imgs/service7.jpg" alt="" />
            <div>
              <h2>Емкости подземные и наземные.</h2>
            </div>
          </Link>
          <Link to={"/services/page"} className="card">
            <img src="../assets/imgs/service8.jpg" alt="" />
            <div>
              <h2>
